...
class MvcElementsTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('mvc_elements')->insert([
            ...
            'view' => '{"grid": {"reopenOnSave": true, "destroyOnClose": true}, "name": "orders", "window": {"title": "Orders", "width": "", "height": ""}, "columns": [{"field": "date", "title": "Date", "width": "", "hidden": false, "sortable": true, "template": "", "groupable": true, "resizable": true, "columnMenu": true, "filterable": true}, {"field": "customer.name", "title": "Customer", "width": "", "hidden": false, "sortable": true, "template": "#: data.customer ? data.customer.name : \'\' #", "groupable": true, "resizable": true, "columnMenu": true, "filterable": true}, {"field": "number", "title": "Number", "width": "", "hidden": false, "sortable": true, "template": "", "groupable": true, "resizable": true, "columnMenu": true, "filterable": true}, {"field": "id", "title": "Id", "width": null, "hidden": true, "sortable": true, "template": null, "groupable": false, "resizable": true, "columnMenu": true, "filterable": true}], "pageSize": 50, "pageable": true, "windowed": true, "timestamps": true}',
